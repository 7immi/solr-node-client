...
Query.prototype.d = function(functions){
   var self = this;
   var parameter = 'd=' + encodeURIComponent(functions);
   this.parameters.push(parameter);
   return self;
}
Query.prototype.pt = function(functions){
   var self = this;
   var parameter = 'pt=' + encodeURIComponent(functions);
   this.parameters.push(parameter);
   return self;
}
Query.prototype.fq = function(functions){
   var self = this;
   var parameter = 'fq=' + encodeURIComponent(functions);
   this.parameters.push(parameter);
   return self;
}
Query.prototype.sfield = function(functions){
   var self = this;
   var parameter = 'sfield=' + encodeURIComponent(functions);
   this.parameters.push(parameter);
   return self;
}
